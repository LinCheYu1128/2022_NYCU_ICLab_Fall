...
using namespace std;
// global variable
vector<vector< vector <int> >>x_matrix(16,vector<vector<int>>(16,vector<int>(16,0)));
vector<vector< vector <int> >>w_matrix(16,vector<vector<int>>(16,vector<int>(16,0)));
vector<vector< vector <int> >>y_matrix(16,vector<vector<int>>(16,vector<int>(16,0)));
vector<vector <int>>out_matrix(16,vector<int>(31,0));
